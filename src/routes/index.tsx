  ...
  head: () => ({
    meta: [
      { title: "Motards de Cœur — La route rapproche les cœurs" },
      {
        name: "description",
        content:
          "Pré-inscrivez-vous au lancement de Motards de Cœur, le projet de communauté pour motards, rencontres, balades et événements.",
      },
      { property: "og:title", content: "Motards de Cœur — Ride. Connect. Feel." },
      {
        property: "og:description",
        content: "Projet de plateforme de rencontres et de communauté pour passionnés de moto.",
      },
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 w-full">
          <div className="max-w-3xl animate-fade-up">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-red text-xs uppercase tracking-[0.3em] text-foreground mb-8">
              <Sparkles className="h-3 w-3" /> Lancement prochain · Pré-inscription gratuite
            </span>
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-xl mb-10 leading-relaxed">
              Rencontres entre motards, balades et communauté moto : rejoignez Motards de Cœur avant
              le lancement et soyez parmi les premiers motards inscrits.
            </p>
            ...
            <div className="flex items-center gap-8 mt-16 text-sm text-muted-foreground">
              <div>
                <div className="text-3xl font-display text-foreground">Gratuite</div>
                <div className="uppercase tracking-wider text-xs">Pré-inscription</div>
              </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-20 animate-fade-up">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Un projet pensé pour des motards qui veulent rouler, échanger et créer des liens plus
              vrais.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Heart,
                title: "Affinités motardes",
                desc: "Objectif : rapprocher les personnes par style de route, valeurs et envies de balade.",
              },
              {
                icon: Users,
                title: "Communauté à construire",
                desc: "La première étape est la pré-inscription, avant l'ouverture progressive des fonctionnalités.",
              },
              {
                icon: Calendar,
                title: "Événements envisagés",
                desc: "Balades, sorties locales et rendez-vous motards pourront être proposés après le lancement.",
              },
              {
                icon: Shield,
                title: "Sécurité prévue",
                desc: "La vérification et la modération feront partie des priorités avant les profils publics.",
              },
              {
                icon: MessageCircle,
                title: "Messagerie à venir",
                desc: "Les échanges privés seront étudiés dans une phase dédiée, après les comptes utilisateurs.",
              },
              {
                icon: Zap,
                title: "Filtres envisagés",
                desc: "Ville, type de moto, style de balade et préférences pourront guider les futures rencontres.",
              },
            ].map((f, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 text-center">
            <p className="mb-5 text-sm text-muted-foreground">
              Le site est en pré-lancement : aucun compte ni paiement n'est demandé aujourd'hui.
            </p>
            <Link
              to="/join"
            ...
            >
              Rejoindre la communauté avant le lancement <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 glass-red p-6 rounded-2xl backdrop-blur-xl max-w-xs">
              <p className="text-sm italic text-foreground/90">
                "Créer un espace où la passion de la route devient le point de départ d'une vraie
                rencontre."
              </p>
          ...
          <div>
            ...
            <h2 className="font-display text-5xl md:text-6xl mt-4 mb-8 leading-tight">
              Le bruit du moteur,
              <br />
              <span className="text-gradient-red italic">le battement d'un cœur.</span>
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Chaque rencontre commence par un regard, mais les plus belles histoires peuvent aussi
              démarrer autour d'une passion commune. Motards de Cœur veut faire de la route un
              terrain d'entente sincère.
            </p>
            <Link
              to="/about"
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                name: "Rencontres",
                role: "Affinités & route",
                img: teamA,
                text: "Permettre à deux passionnés de se trouver autour d'un rythme, d'une région et d'une envie de rouler.",
              },
              {
                name: "Balades",
                role: "Sorties locales",
                img: teamB,
                text: "Aider les motards à ne plus rouler seuls quand ils ont envie de partager un itinéraire.",
              },
              {
                name: "Communauté",
                role: "Respect & passion",
                img: teamC,
                text: "Construire un espace accueillant, clair et sécurisé avant d'ouvrir les fonctionnalités sociales.",
              },
            ].map((t, i) => (
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                date: "À VENIR",
                title: "Balade coucher de soleil — Côte d'Azur",
                loc: "Nice — Monaco",
                img: communityImg,
              },
              {
                date: "À VENIR",
                title: "Festival Iron & Soul",
                loc: "Lyon — à venir",
                img: eventImg,
              },
              {
                date: "À VENIR",
                title: "Balade solidaire des motards",
                loc: "Paris — à venir",
                img: solidaireImg,
              },
            ].map((e, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-between">
                  <span className="self-start glass-red px-3 py-1.5 rounded-full text-xs uppercase tracking-wider">
                    {e.date}
                  </span>
                  <div>
      ...
      <section className="py-32 px-6">
        <div className="mx-auto max-w-5xl glass rounded-3xl overflow-hidden relative ring-red-glow">
          ...
          <div className="relative z-10 p-16 md:p-20">
            <span className="text-primary uppercase tracking-[0.4em] text-xs">
              Rejoignez les premiers
            </span>
            <h2 className="font-display text-5xl md:text-6xl mt-4 mb-6 max-w-2xl">
              La prochaine aventure <span className="text-gradient-red italic">commence ici</span>
            </h2>
            <p className="text-muted-foreground text-lg max-w-xl mb-8">
              Pré-inscrivez-vous gratuitement pour suivre le lancement de la communauté et être
              informé dès l'ouverture des fonctionnalités.
            </p>
            <Link
              to="/join"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-red text-primary-foreground rounded-full uppercase tracking-wider text-sm font-medium shadow-glow hover:scale-105 transition-all"
            >
              Soyez parmi les premiers motards inscrits <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
