    ...
    <Layout>
      <div className="min-h-[calc(100vh-7rem)] bg-[#faf6f0] text-neutral-900">
        {matchName && (
          ...
          >
            <div className="w-full max-w-md rounded-3xl border border-[#e2b45f]/40 bg-white p-8 text-center shadow-[0_0_80px_rgba(226,180,95,0.22)] animate-in zoom-in-95 fade-in-0">
              <div className="mb-6 flex items-center justify-center gap-5 text-[#e2b45f]">
                ...
                <Bike aria-hidden="true" className="h-16 w-16 text-neutral-900" strokeWidth={1.6} />
                <Heart
                  fill="currentColor"
                  aria-hidden="true"
        ...
        <section className="mx-auto max-w-md px-6 py-12 sm:py-16">
          ...
          <div className="mt-3 mb-6 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-full border border-neutral-300 px-4 py-2 text-xs uppercase tracking-wider text-neutral-600 hover:border-[#e2b45f]/60"
            >
              Filtres
            </button>
          </div>
          {filtersOpen && (
            <div className="mb-6 grid gap-4 rounded-2xl border border-neutral-200 bg-white p-5 sm:grid-cols-3">
              ...
              {(filters.minAge ||
                ...
                <button
                  ...
                  className="text-left text-xs text-neutral-400 hover:text-[#e8be6c] sm:col-span-3"
                >
          ...
          {notice && (
            <div className="mb-6 rounded-xl border border-green-500/40 bg-green-500/10 p-4 text-center text-sm text-green-700">
              {notice}
            </div>
          )}
          {error && (
          ...
          {candidates === null && !error && (
            <p className="text-sm text-neutral-600">Chargement des profils…</p>
          )}
          {candidates && !current && (
          ...
          {current && (
            <article
              ...
              className={`relative touch-pan-y select-none overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-[0_24px_60px_rgba(42,31,31,0.14)] ${isDragging ? "cursor-grabbing" : "cursor-grab transition-transform duration-300 ease-out"}`}
              ...
              <div className="p-6">
                ...
                {current.distance_km !== null && current.distance_km !== undefined && (
                  <p className="mt-1 text-xs text-neutral-400">
                    à environ {current.distance_km} km
                  </p>
                )}
                ...
                {current.bio && (
                  <p className="mt-3 text-sm leading-relaxed text-neutral-600">{current.bio}</p>
                )}
                <div className="mt-6 flex justify-center gap-6">
                  <button
                    onClick={() => void swipe(false)}
                    aria-label="Passer"
                    className="flex h-16 w-16 items-center justify-center rounded-full border border-neutral-300 bg-[#f5f0e8] text-neutral-600 transition hover:scale-105"
                  >
                    <Ban />
                  </button>
                  <button
                ...
                <div className="mt-5 flex items-center justify-center gap-5 text-xs text-neutral-400">
                  {lastPassed && (
                    <button
