...
export const Route = createFileRoute("/mentions-legales")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mentions légales du site Motards de Cœur, actuellement publié sur Lovable." },
        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-12">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Ces mentions accompagnent la version actuelle de Motards de Cœur, publiée comme site de présentation et de pré-inscription.
            </p>
          </div>
          ...
          <div className="glass rounded-3xl p-6 md:p-10 space-y-10 text-muted-foreground leading-relaxed">
            <LegalSection title="Site concerné">
              <p>
                Le site Motards de Cœur est accessible à l'adresse https://motarddecoeur.lovable.app.
              </p>
            </LegalSection>
            ...
            <LegalSection title="Éditeur du site">
              <p>
                ...
                Pour l'instant, le site présente le projet Motards de Cœur et permet la pré-inscription au lancement.
              </p>
            </LegalSection>
            ...
            <LegalSection title="Propriété intellectuelle">
              <p>
                Les textes, visuels, éléments de marque et interfaces présents sur le site sont destinés à Motards de Cœur.
